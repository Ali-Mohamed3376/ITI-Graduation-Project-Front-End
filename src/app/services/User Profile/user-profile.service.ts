...
export class UserProfileService {
  ...
  {
    return this.myClient.get<string[]>('https://localhost:7064/api/UserProfile/profile');  
  }

   public EditUser(user:any):Observable <string[]>
  {
      return this.myClient.put<string[]>('https://localhost:7064/api/UserProfile/Edit',user);
  }
  public deleteUser():Observable <string[]>
  {
    return this.myClient.delete<string[]>('https://localhost:7064/api/UserProfile/DeleteUser');
  }
  public changePassword(Change:ChangePasswordDto) :any
  {
    console.log(Change);
    return this.myClient.post('https://localhost:7064/api/UserProfile/Change_Password',Change);
  }
  ...
  {
    return this.myClient.get<string[]>('https://localhost:7064/api/UserAddresses');  
  }
  public addAddress(address:any):Observable<string[]>
  {
    return this.myClient.post<string[]>('https://localhost:7064/api/UserAddresses/AddNewAddress',address);
  }
  public EditUserAddress(address:any):Observable<string[]>
  {
    return this.myClient.put<string[]>('https://localhost:7064/api/UserAddresses/Edit',address);
